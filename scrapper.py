...
def process_urls(client_id, urls, max_depth):
    """
    Function to process the uploaded URLs.
    This function will be called periodically based on the specified frequency.
    """
...
def upload_url():
    ...
    urls = data.get('urls', [])
    max_depth = data.get('max_depth')
    frequency = data.get('frequency', 'minute')  # Default to minute 
